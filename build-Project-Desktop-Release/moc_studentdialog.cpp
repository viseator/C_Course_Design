...
#include "../Project/studentdialog.h"
...
QT_MOC_LITERAL(3, 22, 9) // "self_slot"

    },
    "StudentDialog\0accept\0\0self_slot"
};
...
void StudentDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->accept((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4])),(*reinterpret_cast< QString(*)>(_a[5])),(*reinterpret_cast< QString(*)>(_a[6])),(*reinterpret_cast< QString(*)>(_a[7])),(*reinterpret_cast< QString(*)>(_a[8]))); break;
        ...
        {
            typedef void (StudentDialog::*_t)(QString , QString , QString , QString , QString , QString , QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StudentDialog::accept)) {
                *result = 0;
                return;
            }
        }
...
void *StudentDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_StudentDialog"))
        return static_cast< Ui_StudentDialog*>(const_cast< StudentDialog*>(this));
...
// SIGNAL 0
void StudentDialog::accept(QString _t1, QString _t2, QString _t3, QString _t4, QString _t5, QString _t6, QString _t7, QString _t8)
{
